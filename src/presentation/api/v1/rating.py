...
from src.application.usecase.recommender.update_recommender import UpdateRecommenderUseCase
...
from src.presentation.dependencies.recommender.update_recommender import get_update_recommender_use_case
...
async def add_rating(
        ...
        update_recommender: UpdateRecommenderUseCase = Depends(get_update_recommender_use_case),
):
    new_rating = await use_case.execute(
        **rating.model_dump()
    )
